...
class EmployeeControllerTest {
    ...
    void shouldGet2xxResponseWhileGettingAllEmployees() throws Exception {
        ...
        Mockito.when(employeeDetailsProvider.getAllEmployees()).thenReturn(new Employees(employees));
    ...
    void shouldReturn2xxResponseWithEmployeeWhileFindingEmployeeById() throws Exception {
        ...
        Mockito.when(employeeDetailsProvider.getEmployeeById("1")).thenReturn(Optional.of(employee));
    ...
    void shouldReturn201ResponseWithEmployeeCreationStatus() throws Exception {
        ...
        Mockito.when(employeeDetailsProvider.createEmployee(employee)).thenReturn("Success");
